            ...
            if len(jd_text.strip()) < 50:
                ...
                if jd_data and analysis_rows:
                    ...
                    if not criteria:
                        ...
                        # Prepare normalized skills & tokens per candidate (unchanged)
                        cand_norm_skills = {}
                        cand_tokens = {}
                        for pkt in candidate_packets:
                        ...
                        with status:
                            for i, c in enumerate(criteria):
                                ...
                                for fname in cand_files:
                                    ...
                                    # exact phrase over normalized phrases
                        ...
                        mat_display = mat_df.copy()
                        mat_display.columns = nice_cols
                        st.dataframe(mat_display, width='stretch')

                        # --- Evidence explorer block below stays the same ---
