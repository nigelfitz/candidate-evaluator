...
with overview_tab:
        # Initial helper box shown only before the first analysis run
    if not st.session_state.get("_has_run_once", False):
        st.info("⬅️ Get started. Upload a **Job Description** and one or more **Candidate Resumes** in the left sidebar, then click **Analyze / Update**.")
