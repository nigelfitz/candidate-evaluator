...
if current_page == "Upload & Analyse":
    ...
    with st.sidebar:
        ...
        if current_jd and current_candidates:
            ...
            st.markdown(
                f"<span style='color: #888888;'>Insights: ${cost_info['breakdown']['candidate_insights']:.2f} for {num_insights} candidates<br>"
                f"${cost_info['breakdown']['candidate_insights']/max(num_insights, 1):.2f} per candidate</span>",
                unsafe_allow_html=True
            )
            st.markdown(
                f"<span style='color: #888888;'>JD criteria: ${cost_info['breakdown']['jd_extraction']:.2f}</span>",
                unsafe_allow_html=True
            )
