...
""")
    ...
    if selected_candidates:
        ...
        with col_ind2:
            ...
            if st.button("📄 Generate Combined PDF", use_container_width=True, type="primary"):
                if reportlab is not None:
                        ...
                        try:
                            ...
                            for cand_name in selected_candidates:
                                ...
                                pdf_bytes = to_individual_candidate_pdf(
                                    ...
                                    cat_map, hi, lo, include_evidence
                                )
        ...
        with col_ind3:
            ...
            if st.button("📁 Individual PDFs", use_container_width=True):
                if reportlab is not None:
                    st.info("💡 Click 'Generate Combined PDF' for a single file, or download individually below:")
