...
with st.sidebar:
    ...
    pages = ["Upload & Analyse", "Criteria from JD", "Candidate Scores", "Candidate Insights", "Scoring Explained", "Export", "PDF Tools", "Settings"]
...
if current_page == "Upload & Analyse":
    ...
    # Stop here if no candidates to display
    ...
    # ========== DETAILED SCORES ==========
    with st.expander("📈 Detailed Scores by Criterion", expanded=False):
        st.markdown("View individual criterion scores with color-coding")
